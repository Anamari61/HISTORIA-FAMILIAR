...
function processSearch() {
    ...
    if (input_valid == "0") {
        document.write("<p class=\"searchdecal\">Resultados de la búsqueda - Por favor dar una criterio de búsqueda</p>");
        return;
    }
...
function displayResults(matches) {
    ...
    stringRes += "<p class=\"searchdecal\">" + matches + " resultados encontrados (resultados privados están ocultos)</p><br>";
    stringRes += "<table width=\"100%\" class=\"scrollTable\" >";
    stringRes += "<thead class=\"fixedHeader\"><tr> <th>Sexo</th><th>Id.</th><th>Nombre del individuo</th><th>Num. Sosa</th><th>Fecha del nacimiento</th><th>Fecha de la muerte</th></tr></thead>";
    ...
    for (var i1 = 0; i1 < ID.length; i1++) {
        for (var i2 = 0; i2 < list_found.length; i2++) {
            if (list_found[i2] == ID[i1]) {
                ...
                stringRes += "<tr><td style=\"text-align:center;\">" + sexString + "</td><td>" + arrayofStrings[1] + "</td><td><a href=\"../details/personsdetails_" + arrayofStrings[2] + ".php#" + arrayofStrings[1] + "\" target=\"_top\">" + arrayofStrings[3] + "</a></td><td>" + arrayofStrings[4] + "</td><td>" + arrayofStrings[5] + "</td><td>" + arrayofStrings[6] + "</td></tr>";
            }
        }
    }
...
<div class="title"><a id="top">&nbsp;</a>Búsqueda de individuos</div>
<p class="footer">
<br /><br />
<a href="../index.php#top" ><img src="../theme/h.gif" alt="Página de bienvenida" title="Página de bienvenida"/></a>
</p>
<p class="searchdecal">Criterios de b&uacute;squeda</p>
<form id="searchInputForm" method="get" action="search_0.php">
<table border="0" cellspacing="0" cellpadding="5" class="searchtable">
<tr><td>Nombre:</td><td><input id="key_fn" name="key_fn" type="text" size="15" />&nbsp;<input id="key_xfn" name="key_xfn" type="checkbox" value="on" />palabra completa</td></tr>
<tr><td>Apellido:</td><td><input id="key_ln" name="key_ln" type="text" size="15" />&nbsp;<input id="key_xln" name="key_xln" type="checkbox" value="on" />palabra completa</td></tr>
<tr><td>Lugar:</td><td><input id="key_pl" name="key_pl" type="text" size="15" />&nbsp;<input id="key_xpl" name="key_xpl" type="checkbox" value="on" />palabra completa</td></tr>
<tr><td>Identificaci&oacute;n:</td><td><input id="key_id" name="key_id" type="text" size="15" />&nbsp;<input id="key_xid" name="key_xid" type="checkbox" value="on" />palabra completa</td></tr>
<tr><td>N&uacute;mero Sosa:</td><td><input id="key_so" name="key_so" type="text" size="15" />&nbsp;<input id="key_xso" name="key_xso" type="checkbox" value="on" />palabra completa</td></tr>
<tr><td>A&ntilde;o del nacimiento:</td><td>&gt;=&nbsp;<input id="key_1bi" name="key_1bi" type="text" size="5" />&nbsp;y &lt;=&nbsp;<input id="key_2bi" name="key_2bi" type="text" size="5" />&nbsp;&nbsp;<input id="key_xbi" name="key_xbi" type="checkbox" value="on" />No </td></tr>
<tr><td>A&ntilde;o del matrimonio:</td><td>&gt;=&nbsp;<input id="key_1ma" name="key_1ma" type="text" size="5" />&nbsp;y &lt;=&nbsp;<input id="key_2ma" name="key_2ma" type="text" size="5" />&nbsp;&nbsp;<input id="key_xma" name="key_xma" type="checkbox" value="on" />No </td></tr>
<tr><td>A&ntilde;o de la muerte:</td><td>&gt;=&nbsp;<input id="key_1de" name="key_1de" type="text" size="5" />&nbsp;y &lt;=&nbsp;<input id="key_2de" name="key_2de" type="text" size="5" />&nbsp;&nbsp;<input id="key_xde" name="key_xde" type="checkbox" value="on" />No </td></tr>
<tr><td colspan="2" align="center"><br /><input id="andor1" name="andor" type="radio" value="and" checked />Y&nbsp;&nbsp;&nbsp;<input id="andor2" name="andor" type="radio" value="or" />O</td></tr>
<tr><td colspan="2" align="center"><br />
<input id="OK" type="submit" value="Buscar" />&nbsp;&nbsp;
<input id="reset" type="reset" value="Eliminar" />&nbsp;&nbsp;
</td></tr>
</table>
</form>
<br>
<hr>
<p class="searchdecal">Resultados de la b&uacute;squeda</p>
<br>
<p id="result"></p>
<p><a id="bot"></a>&nbsp;</p>
